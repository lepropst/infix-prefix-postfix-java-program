...
public class GraphicTree extends TreeNode<String> {

    public GraphicTree(TreeNode<String> node) {
...
class BTreePrinter {
    ...
    public static <T extends Comparable<?>> void printNode(TreeNode<T> root) {
    	//returns how many times you can call the left function
        int maxLevel = BTreePrinter.maxLevel(root);
        //print internal nodes starting from level one, with maxLevel levels.
